...
export default function Clients() {
  ...
  return (
    <section className="pt-2 pb-10 md:pb-14 text-black overflow-hidden" id="clients" aria-label="Trusted by">
      {/* Eyebrow label, contained */}
      <div className="mx-auto px-6 sm:px-12 lg:px-32 max-w-[1600px] mb-9 md:mb-12">
