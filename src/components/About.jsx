...
export default function About() {
  return (
    <section className="py-14 md:py-20 text-black" id="about">
      <div className="mx-auto px-6 sm:px-12 lg:px-32 max-w-[1600px]">

        {/* Header */}
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-7 mb-10 md:mb-12">
        ...
        {/* Statement + narrative */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16 items-center mb-12 md:mb-16">
          ...
          <div className="md:col-span-6 md:order-2 md:pl-8 md:border-l border-black/15">
