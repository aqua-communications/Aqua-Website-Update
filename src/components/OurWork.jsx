...
export default function OurWork() {
  ...
  return (
    <section className="py-14 md:py-20 text-black" id="our-work">
      <div className="aqua-container">
        ...
        <div className="mt-7 flex justify-end">
          <Link to="/work" className="text-[11px] font-bold uppercase tracking-[0.16em] border-b border-black/30 pb-1 hover:border-black">View selected work ↗</Link>
        </div>
      </div>
    </section>
  );
