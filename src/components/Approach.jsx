...
export default function Approach() {
  return (
    <section className="py-14 md:py-20 text-black" id="approach">
      <div className="mx-auto px-6 sm:px-12 lg:px-32 max-w-[1600px]">
        ...
        <div className="max-w-5xl mx-auto">
          {layers.map((l) => (
            <div
              key={l.num}
              className="group relative grid grid-cols-12 gap-y-3 md:gap-x-6 items-start md:items-center py-5 md:py-7 border-t border-black/15 last:border-b"
            >
              {/* Number */}
