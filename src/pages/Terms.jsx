...
export default function Terms({ lenis }) {
  usePageMeta({ title: 'Terms of Service | AQUA Innovations', description: 'Terms governing use of the AQUA Innovations website and the framework behind client engagements.', path: '/terms' });
  return (
    <LegalPage
