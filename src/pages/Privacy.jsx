...
export default function Privacy({ lenis }) {
  usePageMeta({ title: 'Privacy Policy | AQUA Innovations', description: 'How AQUA Innovations handles information shared through the website, project enquiries and produced experiences.', path: '/privacy' });
  return (
    <LegalPage
